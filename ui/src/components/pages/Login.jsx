...
const Login = async () => {
  ...
  return (
      <section className="login w-full h-[80vh] mt-12">
        <div
            className="border border-primary/30 shadow-lg bg-neutral/60 rounded-lg login-container container w-[95%] m-auto p-8 md:flex md:justify-between md:items-center md:max-w-6xl relative">
