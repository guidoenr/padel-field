...
const Weather = () => {
  return (
    <div className="weather-container absolute top-[-2.5rem] left-0 flex items-center justify-center w-full z-40 select-none">
      <div className="bg-neutral/80 px-3 py-1 flex gap-2 items-center rounded-lg border border-primary/30 hover:border-primary hover:scale-105 transition ease-in-out">
